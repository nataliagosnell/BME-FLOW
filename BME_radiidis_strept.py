...
data = pandas.read_excel("/Users/raphaelschloubi/Desktop/Year 4/BME/bme_AuNPs_DLS_sAv_2024-11-26_12-09-21/Sample 8/Sample 8.xlsx")
...
plt.title("Radius distribution at pH = 8.0") 
plt.xlim(0, 60)
